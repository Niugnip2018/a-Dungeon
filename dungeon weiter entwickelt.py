...
> = stiege runter
@ = Kevin the hero
gieb die nummern der sachen die du haben willst ein
"""
kevin = "@"
keller1 = """
########################################    
...
while p1.hp > 0 and p1.hunger < 100:
    ...
    if p1.hunger > 50:
        special += " *hungry* "
    status = "{}\nhp: {} hu: {} food: {} med: {} coins: {} stärcke: {} rüstung: {}\n    ".format(
             special, p1.hp, p1.hunger, p1.food, p1.heal, p1.coins, p1.attack, p1.defense)
    # ---- keyboard control -----
    ...
    if command == "1":
        if p1.coins > 200:
            p1.attack += 1
            print ("du bekommst mehr stärcke")
        else:
            print ("du hast nicht genug geld")
    if command == "2":
        if p1.coins > 150:
            p1.defense += 1
            print ("du bekommst mehr rüstungspunckte")
        else:
            print ("du hast nicht genug geld")
    if command == "3":
        if p1.coins > 50:
            p1.medipack += 1
            print ("du bekommst ein medipäck")
        else:
            print ("du hast nicht genug geld")
    if command == "4":
        if p1.coins > 50:
            p1.food += 1
            print ("du bekommst eine banane")
        else:
            print ("du hast nicht genug geld")
    # --- climb stair ----
